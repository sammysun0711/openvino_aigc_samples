...
class AnimateDiffPipeline(
    ...
    def __init__(
        ...
        print("self.vae.config.block_out_channels: ", len(self.vae.config.block_out_channels))
    ...
    def encode_prompt(
        ...
        print("prompt_embeds.shape before process ", prompt_embeds.shape)
        # duplicate text embeddings for each generation per prompt, using mps friendly method
        prompt_embeds = prompt_embeds.repeat(1, num_images_per_prompt, 1)
        prompt_embeds = prompt_embeds.view(bs_embed * num_images_per_prompt, seq_len, -1)
        print("prompt_embeds.shape after process ", prompt_embeds.shape)
    ...
    def __call__(
        ...
        **kwargs,
        ...
        print("self.unet.config.sample_size: ", self.unet.config.sample_size)
        ...
        print("self.unet.config.in_channels: ", self.unet.config.in_channels)
...
adapter = MotionAdapter.from_pretrained("animatediff-motion-adapter-v1-5-2") #torch_dtype=torch.float16)
...
frames = output.frames[0]
export_to_gif(frames, "animatelcm-motion-lora_pt.gif")