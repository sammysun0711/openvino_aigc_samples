...
def main():
    ...
    parser.add_argument(
        "-cd", "--cache_dir", default="model_cache", type=str, help="Folder to save model cache"
    )
    parser.add_argument(
        "-mnt", "--max_new_tokens", default=1024, type=int, help="Specify maximum generated tokens counter"
    )
